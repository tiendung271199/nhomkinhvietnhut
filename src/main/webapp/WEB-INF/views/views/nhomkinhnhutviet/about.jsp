...
<section class="bg-light w-100">
    <div class="container">
        <div class="row d-flex align-items-center py-5">
            ...
            <div class="col-lg-6">
                <img src="${contextPath}/assets/img/banner-img-02.svg">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="pt-5 pb-3 d-lg-flex align-items-center gx-5">
        ...
        <div class="col-lg-9 row">
            <div class="team-member col-md-4">
                <img class="team-member-img img-fluid rounded-circle p-4" src="${contextPath}/assets/img/team-01.jpg" alt="Card image">
            ...
            <div class="team-member col-md-4">
                <img class="team-member-img img-fluid rounded-circle p-4" src="${contextPath}/assets/img/team-02.jpg" alt="Card image">
                <ul class="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                    <li>Jane Doe</li>
            ...
            <div class="team-member col-md-4">
                <img class="team-member-img img-fluid rounded-circle p-4" src="${contextPath}/assets/img/team-03.jpg" alt="Card image">
                <ul class="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                    <li>Sam</li>
                    <li>Developer</li>
                </ul>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="banner-img col-lg-5">
                <img src="${contextPath}/assets/img/work.svg" class="rounded img-fluid" alt="">
            </div>
